---
title: Loco Place Architecture Decisions
type: decision-index
status: active
scope: platform
updated: 2026-08-30
...
These short ADR-style records capture **why** durable constraints exist. Code shows what exists; these records explain the decision that should survive refactoring.

Accepted records:

1. [0001-modular-monolith.md](0001-modular-monolith.md)
2. [0002-canonical-customer-account.md](0002-canonical-customer-account.md)
