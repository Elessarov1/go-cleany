...
function ActiveTransactionCard({ count, item, locale, russian }: {
  ...
  return (
    <div className="customer-home__active-wrap">
      ...
      <Link className="customer-home-card customer-home-card--active" data-service={item.service.toLowerCase()} to={actionTargetPath(item.action)}>
...
function PrimaryActionCard({ action, locale }: { action: CustomerHomePrimaryAction; locale: string }) {
  const { t } = useTranslation();
  return (
    <Link className="customer-home-card customer-home-card--opportunity" data-service={action.targetService.toLowerCase()} to={actionTargetPath(action.action)}>
...
function RepeatCard({ opportunity, locale }: { opportunity: CustomerHomeRepeatOpportunity; locale: string }) {
  ...
  return (
    <Link className="customer-home-card customer-home-card--opportunity" data-service={opportunity.service.toLowerCase()} to={actionTargetPath(opportunity.action)}>
